      ...
      <div className="  inset-0 flex justify-center py-10 mb-10 my-5 px-4 z-0 relative">
        ...
        <div className="flex justify-center w-full max-w-[800px] pt-2.5">
          ...
          <img
            ...
            alt="Thể lệ"
            className="absolute z-10 top-2.5 left-1/2 -translate-x-1/2 w-[300px] h-auto p-1.5"
          />
          {/* Khung lớn popup */}
          <div
          ...
          >
            ...
            >
              {/* Nội dung table rule */}
              <div className="relative flex-col flex justify-center text-left m-0 p-8 pt-2.5">
                ...
                >
                  <div className="text-left leading-normal text-[16px] mt-4">
                    ...
                    <table className="min-w-full mb-5 ">
                      ...
                      <tbody className="border border-[white] text-[#233DA3]">
                    ...
                    <table className="min-w-full mb-5 ">
                      ...
                      <tbody className="border border-[white] text-[#233DA3] text-[14px] p-4">
                        <tr className="border-b border-[white]  p-4">
