    ...
    >
      ...
      <div className="relative flex justify-center  w-full max-w-[800px] pt-[200px]">
        ...
        <img
          ...
          alt="Oventin Logo"
          className="absolute top-[20px] left-1/2 -translate-x-1/2 w-[150px] h-auto rounded-full p-1.5 filter-[drop-shadow(rgb(255,255,255)_0px_0px_5px)] z-[1005]"
        />
        {/* Title */}
        <img
            ...
            <div className="relative flex-col flex justify-center text-left m-0 p-6 pt-[40px]">
              <form id="otp-form" onSubmit={handleSubmit(handleConfirmOTP)} className="flex flex-col gap-3 text-[#233da3]">
                <div className="relative pb-5">
                  <label htmlFor="otp" className="block text-sm font-medium text-white/100 mb-1">
